...
- **test_matching.py** - what counts as the same part and what must not:
  ...
  geometry, colour-list wrap-around, locked layers, panel tagging,
  gathering each type into a block, and the `PANELCLOSE` and
  `PANELRESET` commands. It also covers the two
